...
Example below show how fmu-dataio can be used in a post-processing context, here in a
...
In such a context, easy access to statisticsal representations of the ensemble is important.
