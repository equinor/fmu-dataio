...
def _derive_index(
    ...
    warnings.warn(
        "No table index columns found. If the table has index columns "
        "e.g. DATE, they should be provided through the 'table_index' argument."
    )
    return _derive_index_legacy(table_columns)
