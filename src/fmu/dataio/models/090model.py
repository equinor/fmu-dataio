...
class AllOfItem(BaseModel):
    field_ref: str | None = Field(default=None, alias="$ref")
    field_comment: str | None = Field(default=None, alias="$comment")
