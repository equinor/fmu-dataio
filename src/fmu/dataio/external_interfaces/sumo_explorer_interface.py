...
from fmu.dataio._readers.tsurf import TSurfData, read_tsurf_file
...
class SumoExplorerInterface:
    def __init__(
        ...
        # TODO: @ecs: hack for "testing" start
        print()
        print("*************** Using SUMO DEV environment ***************")
        print()
        env = "dev"
        # TODO: @ecs: hack for "testing" end
            ...
            case ObjectMetadataClass.surface:
                match self._fmu_layout:
                    ...
                    case Layout.triangulated:
                        return read_tsurf_file(data_object.blob)
