...
class _ExportGridExtractedDepthSurfaces(SimpleExportRMSBase):
    ...
    def _get_export_config(self, name: str) -> ExportConfig:
        ...
        return (
            ...
            .file_config(
                name=name,
                subfolder=StandardResultName.grid_extracted_depth_surface,
            )
            .access(Classification.internal, rep_include=True)
            .global_config(self._config)
            .standard_result(StandardResultName.grid_extracted_depth_surface)
            .build()
        )
...
def export_grid_extracted_depth_surfaces(
    project: Any,
    horizon_folder: str,
) -> ExportResult:
    ...
    return _ExportGridExtractedDepthSurfaces(project, horizon_folder).export()
