...
class _ExportDepthPredictionSurfaces:
    def __init__(
        self,
        project: Any,
        horizon_folder: str,
    ...
    @property
    def _product(self) -> product.DepthPredictionSurfaceProduct:
        """Product type for the exported data."""
        return product.DepthPredictionSurfaceProduct(
            name=ProductName.depth_prediction_surface
        )
    ...
    def _export_surface(self, surf: xtgeo.RegularSurface) -> ExportResultItem:
        ...
        absolute_export_path = edata._export_with_product(surf, product=self._product)
...
def export_depth_prediction_surfaces(
    ...
    Examples:
        Example usage in an RMS script::
            ...
            export_results = export_depth_prediction_surfaces(project, "DS_extracted")
    ...
    return _ExportDepthPredictionSurfaces(project, horizon_folder).export()
