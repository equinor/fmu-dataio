...
All fixtures represent full datasets from Drogon.
As an example, when representing faults in a structural model, the fixture should
equal the full set of faults in that structural model.
"""
...
def mock_project_variable(mock_general2d_data, mock_structural_model):
    ...
    # Syntax ex: mock_project.structural_models["GF_depth_hum"].fault_model.fault_names
