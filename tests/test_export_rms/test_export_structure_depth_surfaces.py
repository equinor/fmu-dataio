...
) -> Generator[_ExportStructureDepthSurfaces]:
...
def test_files_exported_with_metadata(
    mock_export_class: _ExportStructureDepthSurfaces, rmssetup_with_fmuconfig: Path
) -> None:
...
def test_public_export_function(
    mock_project_variable: MagicMock, mock_export_class: _ExportStructureDepthSurfaces
) -> None:
