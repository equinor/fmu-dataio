        ...
        masterdata=fields.Masterdata(
            smda=fields.Smda(
                coordinate_system=fields.CoordinateSystem(
                    ...
                    uuid="15ce3b84-766f-4c93-9050-b154861f9100",  # type: ignore[arg-type]
                ),
                country=[
                    fields.CountryItem(
                        identifier="Norway",
                        uuid="ad214d85-8a1d-19da-e053-c918a4889309",  # type: ignore[arg-type]
                    ),
                ],
                discovery=[
                    fields.DiscoveryItem(
                        short_identifier="abdcef",
                        uuid="56c92484-8798-4f1f-9f14-d237a3e1a4ff",  # type: ignore[arg-type]
                    ),
                ],
